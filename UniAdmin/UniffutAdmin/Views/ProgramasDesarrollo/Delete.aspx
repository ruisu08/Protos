...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Eliminar pagina de programas de desarollo
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <div id="headerContenido">
        <h1>Eliminar pagina de programas de desarollo</h1>
    </div>

    <form id="validateForm" action= '<%:Url.Action("Delete","PaginasDesarrollo")%>' method="post">
