...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Páginas de programas de desarrollo
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div id="topBar">
            <div id="searchBar"> 
                <form id="searchForm" action= '<%:Url.Action("Search","ProgramasDesarrollo")%>' method="post">
        ...
        <div id="contenidoHeader">
            <div id="contenedorContenidoTitulo">
                <h1 id="contenidoTitulo">Páginas de programas de desarrollo:</h1>
                <h4 id="contenidoDescripcion">Administración de base de datos de páginas sobre programas de desarrollo de la Uniffut</h4>
            </div>
            <div id="contenedorCrear">
                <%:Html.ActionLink("Crear nueva página de programas de desarrollo", "Create") %>
            </div>
        </div>
