...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Editar página de programa de desarrollo
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <div id="headerContenido">
        <h1>Editar página de programa de desarrollo</h1>
    </div>

    <form id="validateForm" action= '<%:Url.Action("Edit","PaginasDesarrollo")%>' method="post">
