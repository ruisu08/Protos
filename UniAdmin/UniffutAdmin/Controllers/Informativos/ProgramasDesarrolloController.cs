...
namespace UniffutAdmin.Controllers.Informativos
{
    public class ProgramasDesarrolloController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var paginas = db.pagina_informativa.Where<pagina_informativa>(r => r.estado == true && r.isPDD == true);
        ...
        public ActionResult Search(String titulo, String autor)
        {
            ...
            var paginas = db.pagina_informativa.Where<pagina_informativa>(r => (r.titulo.Equals(titulo) || r.usuario.apellido.Equals(autor) || r.usuario.identificacion.Equals(autor)) && r.estado == true && r.isPDD == true);
