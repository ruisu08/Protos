...
CREATE TABLE `album_multimedia_jugadora` (
  ...
  CONSTRAINT `R_album_multimedia` FOREIGN KEY (`idAlbum`) REFERENCES `album_jugadora` (`idAlbum_Jugadora`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `R_multimedia_album` FOREIGN KEY (`idMultimedia`) REFERENCES `multimedia` (`idMultimedia`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-03-18 12:11:16
