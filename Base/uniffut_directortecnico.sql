...
CREATE TABLE `directortecnico` (
  `idDirectorTecnico` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_DirectorTecnico_Equipo1_idx` (`Equipo_idEquipo`),
  CONSTRAINT `fk_DirectorTecnico_Equipo1` FOREIGN KEY (`Equipo_idEquipo`) REFERENCES `equipo` (`idEquipo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-03-25 22:28:08
