...
DROP TABLE IF EXISTS `album_equipo`;
...
--
-- Dumping data for table `album_equipo`
--

LOCK TABLES `album_equipo` WRITE;
/*!40000 ALTER TABLE `album_equipo` DISABLE KEYS */;
INSERT INTO `album_equipo` VALUES (1,'Sin título',16,1);
...
-- Dump completed on 2013-03-15  1:47:19
